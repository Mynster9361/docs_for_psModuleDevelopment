...
Remove-Module YourModuleName -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\YourModuleName\YourModuleName.psd1"
Import-Module "$PSScriptRoot\..\YourModuleName\YourModuleName.psm1" -Force
