...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\YourModuleName\functions", "$global:testroot\..\YourModuleName\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\YourModuleName\functions"
    "$global:testroot\..\YourModuleName\internal\functions"
)
